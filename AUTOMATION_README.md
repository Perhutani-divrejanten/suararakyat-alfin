...
- **email**: Email portal (akan replace "Suararakyat33@gmail.com")
- **socialHandle**: Handle social media (akan replace "suararakyat")
- **colors**: Tema warna
...
| `Suararakyat` | `siteName` (tanpa spaces) |
| `suararakyat` | `socialHandle` |
| `Suararakyat33@gmail.com` | `email` |
